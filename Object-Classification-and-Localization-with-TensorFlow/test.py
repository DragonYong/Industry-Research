...
with tf.Session() as session:
    ...
    new_saver.restore(session, "ckpt/CNN_OL.ckpt")
...
for i in range(len(k)):
    ...
    if r == 0:
        pred_labels.append("cucumber")
    elif r == 1:
        pred_labels.append("eggplant")
    elif r == 2:
        pred_labels.append("mushroom")
